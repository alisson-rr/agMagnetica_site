import { Bot, CalendarCheck, Mail, BarChart3 } from "lucide-react";
      ...
      <div className="container mx-auto">
            ...
            {etapas.map((etapa, index) => (
              ...
              >
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 gold-gradient rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <etapa.icon className="w-7 h-7 text-white" />
                  </div>
                  {index < etapas.length - 1 && (
                    <div className="w-1 h-16 gold-gradient mx-auto mt-4" />
                  )}
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-sm text-primary font-medium">IA responde instantaneamente</span>
                  </div>
                ...
                <div className="bg-accent/10 border border-accent/20 rounded-lg p-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-sm text-accent font-medium">Agendamento automático</span>
                  </div>
        ...
        <div className="text-center mt-16">
          <button 
            ...
            className="btn-premium text-sm sm:text-lg px-6 sm:px-8 py-4 h-auto"
          >
