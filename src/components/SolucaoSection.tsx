        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-foreground/70 leading-relaxed">
              ...
              <span className="text-primary font-semibold">humanizada e calorosa</span>, 
              ...
              <div className="bg-gray-900 rounded-2xl overflow-hidden">
                ...
                <div className="p-4 space-y-4 h-96 overflow-y-auto">
                  <div className="bg-white/10 rounded-lg p-3 max-w-xs">
                    <p className="text-sm text-white">Olá! Gostaria de saber sobre preços de botox</p>
                    <span className="text-xs text-white/50">14:30</span>
                  </div>
                  ...
                  <div className="bg-white/10 rounded-lg p-3 max-w-xs">
                    <p className="text-sm text-white">Testa e ao redor dos olhos</p>
